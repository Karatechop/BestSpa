<div class="navbar navbar-default">
  ...
  <div class="navbar-collapse collapse navbar-responsive-collapse">
    ...
    <li><a href="/adminpanel/types">Types</a></li>
		...
		{{ Form::text('query', '', array('class'=>'form-control col-lg-8', 'placeholder'=>'Look for salons')) }}
    ...
    <ul class="nav navbar-nav">
      <li><a href="/adminpanel/salons/create" class="btn btn-primary">Add a new salon</a></li>
    </ul>
