<div class="navbar navbar-default">
  ...
  <div class="navbar-collapse collapse navbar-responsive-collapse">
    ...
    <li class="active"><a href="/adminpanel">Services</a></li>
    <li><a href="/adminpanel/salons">Salons</a></li>
    <li><a href="/adminpanel/kinds">Kinds</a></li>
    <li><a href="/adminpanel/types">Types</a></li>
    </ul>
    
    	{{ Form::open(array('class'=> 'navbar-form navbar-left', 'url' => '/adminpanel/services/search', 'method' => 'GET')) }}
    ...
    <ul class="nav navbar-nav">
     <li><a href="/adminpanel/services/create" class="btn btn-primary">Add a new service</a></li>
    </ul>
